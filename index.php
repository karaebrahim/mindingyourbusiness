...
?>
            ...
            <div id="welcome">
                <div class="box">
                    <h1>greater portland bookkeeping services</h1>
                    <p>Minding Your Business, Inc. offers <a href="services.php">expert bookkeeping and payroll services</a> for small businesses and individuals throughout Southern Maine. I provide customized services designed to fit your distinct needs. Whether you require one-time assistance setting up your accounting program or ongoing bookkeeping support, I have the skills to get the job done.</p>
            ...
            <div id="benefits">
                <div class="box">
                    <h1>why hire an experienced bookkeeper?</h1>
                    <ul>
